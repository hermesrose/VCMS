            ...
            <div class="row m-t-lg">
                <div class="col-md-12">
                    <div class="form-group">
                            <form action="/VCMS/ACCOUNT_300/accountList.do"  id="searchForm" name="searchForm"  method="POST">
                                <div class=SearchBox>
                                    <table class=Layout>
                                        <tbody>
                                            <tr class="First">
                          ...
                          <button  class="btn btn-primary" id="btnNavbarSearch" onclick="location.href='/VCMS/ACCOUNT_300/accountWrite.do'" >申請する</button>
                          </div>
									...
									<table cellspacing="0" cellpadding="0" rules="all" border="0"
										...
										<c:forEach items="${LISTSELECT}" var="list" varStatus="status">
										    <tr>
												...
												<td style="text-align: center"><a href="javascript:void(0);" onclick="location.href='/VCMS/ACCOUNT_300/accountView.do?gitAppNo=${list.GIT_APP_NO}'" >${list.GIT_NM}</a></td>
							...
							<div align="center">
								<nav aria-label="Customzing the active number">
									<ul class="pagination justify-content-right" id="main-form-hide-pageing">
										<li class="page-item"><a class="page-link" href="/VCMS/ACCOUNT_300/accountList.do?row=${startPage-10}&&gitDateFrom=${gitDateFrom}&&gitDateTo=${gitDateTo}&&gitId=${gitId}&&gitNm=${gitNm}&&gitEmail=${gitEmail}&&gitCompany=${gitCompany}&&gitMovnStat=${gitMovnStat}">以前</a></li>
										<c:forEach begin="${startPage}" end="${endPage}" var="g">	
											<li class="page-item"><a class="page-link"   href="/VCMS/ACCOUNT_300/accountList.do?row=${g}&&gitDateFrom=${gitDateFrom}&&gitDateTo=${gitDateTo}&&gitId=${gitId}&&gitNm=${gitNm}&&gitEmail=${gitEmail}&&gitCompany=${gitCompany}&&gitMovnStat=${gitMovnStat}">${g}</a></li>			
										</c:forEach>
										<li class="page-item"><a class="page-link" href="/VCMS/ACCOUNT_300/accountList.do?row=${startPage+10}&&gitDateFrom=${gitDateFrom}&&gitDateTo=${gitDateTo}&&gitId=${gitId}&&gitNm=${gitNm}&&gitEmail=${gitEmail}&&gitCompany=${gitCompany}&&gitMovnStat=${gitMovnStat}">次</a></li>
									</ul>
								</nav>
							</div>
						</div>						 
