            ...
            <div class="row m-t-lg">
                <div class="col-md-12">
                    <div class="form-group">
                            <form action="/VCMS/DBAPO_400/dbApoList.do"  id="searchForm" name="searchForm"  method="POST">
                                <div class=SearchBox>
                                    <table class=Layout>
                                        <tbody>
                                            <tr class="First">
                          ...
                          <button  class="btn btn-primary" id="btnNavbarSearch" onclick="location.href='/VCMS/DBAPO_400/dbApoWrite.do'" >申請する</button>
                          </div>
									...
									<table cellspacing="0" cellpadding="0" rules="all" border="0"
										...
										<tbody>											
										    ...
										    <tr>
										        ...
										        <td style="text-align: center"><a href="javascript:void(0);" onclick="location.href='/VCMS/DBAPO_400/dbApoView.do?gitDbAppNo=${list.GIT_DB_APP_NO}'" >${list.GIT_DB_WORK_NM}</a></td>
							...
							<div align="center">
								<nav aria-label="Customzing the active number">
									<ul class="pagination justify-content-right" id="main-form-hide-pageing">
										<li class="page-item"><a class="page-link" href="/VCMS/DBAPO_400/dbApoList.do?row=${startPage-10}&&gitDbDateFrom=${gitDbDateFrom}&&gitDbDateTo=${gitDbDateTo}&&gitDbWorkNm=${gitDbWorkNm}&&gitDbAppNm=${gitDbAppNm}&&gitDbDbNm=${gitDbDbNm}&&gitDbAppDbNm=${gitDbAppDbNm}&&gitDbMovnStat=${gitDbMovnStat}">以前</a></li>
										<c:forEach begin="${startPage}" end="${endPage}" var="g">	
											<li class="page-item"><a class="page-link"   href="/VCMS/DBAPO_400/dbApoList.do?row=${g}&&gitDbDateFrom=${gitDbDateFrom}&&gitDbDateTo=${gitDbDateTo}&&gitDbWorkNm=${gitDbWorkNm}&&gitDbAppNm=${gitDbAppNm}&&gitDbDbNm=${gitDbDbNm}&&gitDbAppDbNm=${gitDbAppDbNm}&&gitDbMovnStat=${gitDbMovnStat}">${g}</a></li>			
										</c:forEach>
										<li class="page-item"><a class="page-link" href="/VCMS/DBAPO_400/dbApoList.do?row=${startPage+10}&&gitDbDateFrom=${gitDbDateFrom}&&gitDbDateTo=${gitDbDateTo}&&gitDbWorkNm=${gitDbWorkNm}&&gitDbAppNm=${gitDbAppNm}&&gitDbDbNm=${gitDbDbNm}&&gitDbAppDbNm=${gitDbAppDbNm}&&gitDbMovnStat=${gitDbMovnStat}">次</a></li>
									</ul>
								</nav>
							</div>
						</div>						 
