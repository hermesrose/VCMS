                ...
                <section class="card card-blue mb-3">
                  ...
                  <div class="card-block">
                    ...
                    <div class="form-group">
                        ...
                        <c:forEach items="${accessView}" var="view" varStatus="status">              
                            <button type="button" class="btn btn-primary btn-sm" onclick="location.href='/VCMS/ACCESS_600/accessModify.do?accAppNo=${view.ACC_APP_NO}'">修正する</button>
                        </c:forEach>
