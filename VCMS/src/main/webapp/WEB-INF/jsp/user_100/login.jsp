...
<body class="login_body" style="background: url(${path}/resources/images/bg_login03.png) no-repeat center 0; width: 1860px; min-width: 1580px; position: relative; margin: 0 auto; background-size: auto 150%;">
