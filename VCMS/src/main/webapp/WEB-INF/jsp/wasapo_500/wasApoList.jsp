            ...
            <div class="row m-t-lg">
                <div class="col-md-12">
                    <div class="form-group">
                           <form action="/VCMS/WASAPO_500/wasApoList.do"  id="searchForm" name="searchForm"  method="POST">
                                <div class=SearchBox>
                                    <table class=Layout>
                                        <tbody>
                                            <tr class="First">
                          ...
                          <button  class="btn btn-primary" id="btnNavbarSearch" onclick="location.href='/VCMS/WASAPO_500/wasApoWrite.do'" >申請する</button>
                          </div>
									...
									<table cellspacing="0" cellpadding="0" rules="all" border="0"
										...
										<c:forEach items="${LISTSELECT}" var="list" varStatus="status">
											<tr>
												...
												<td style="text-align: center;"><a href="javascript:void(0);" onclick="location.href='/VCMS/WASAPO_500/wasApoView.do?gitWasAppNo=${list.GIT_WAS_APP_NO}'" >${list.GIT_WAS_WORK_NM}</a></td>
							...
							<div align="center">
								<nav aria-label="Customzing the active number">
									<ul class="pagination justify-content-right" id="main-form-hide-pageing">
										<li class="page-item"><a class="page-link" href="/VCMS/WASAPO_500/wasApoList.do?row=${startPage-10}&&gitWasDateFrom=${gitDbDateFrom}&&gitWasDateTo=${gitWasDateTo}&&gitWasWorkNm=${gitWasWorkNm}&&gitWasAppNm=${gitWasAppNm}&&gitWasConNm=${gitWasConNm}&&gitWasServer=${gitWasServer}&&gitWasMovnStat=${gitWasMovnStat}">以前</a></li>
										<c:forEach begin="${startPage}" end="${endPage}" var="g">	
											<li class="page-item"><a class="page-link"   href="/VCMS/WASAPO_500/wasApoList.do?row=${g}&&gitWasDateFrom=${gitDbDateFrom}&&gitWasDateTo=${gitWasDateTo}&&gitWasWorkNm=${gitWasWorkNm}&&gitWasAppNm=${gitWasAppNm}&&gitWasConNm=${gitWasConNm}&&gitWasServer=${gitWasServer}&&gitWasMovnStat=${gitWasMovnStat}">${g}</a></li>			
										</c:forEach>
										<li class="page-item"><a class="page-link" href="/VCMS/WASAPO_500/wasApoList.do?row=${startPage+10}&&gitWasDateFrom=${gitDbDateFrom}&&gitWasDateTo=${gitWasDateTo}&&gitWasWorkNm=${gitWasWorkNm}&&gitWasAppNm=${gitWasAppNm}&&gitWasConNm=${gitWasConNm}&&gitWasServer=${gitWasServer}&&gitWasMovnStat=${gitWasMovnStat}">次</a></li>
									</ul>
								</nav>
							</div>
						</div>						 
